...
public class WishlistDAO {
    public boolean createWishlist(int custid, ArrayList<Car> listcar) throws SQLException, ClassNotFoundException{
        boolean rs = false;
        Connection cn=null;
    ...
    public ArrayList<Wishlist> getWishlists() throws ClassNotFoundException, SQLException{
    ...
    public Wishlist getWishlist(int wishlistId) throws ClassNotFoundException, SQLException{
